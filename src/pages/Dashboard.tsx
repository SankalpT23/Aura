    ...
    <div className="p-6 space-y-6 bg-background min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {portfolioStats.map((stat, index) => (
          <Card key={index} className="aura-card p-6 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-3">
              {quickActions.map((action, index) => (
                <Button
                  key={index}
                  variant="outline"
                  className="w-full justify-start h-12 hover:bg-primary/10 hover:border-primary/50 transition-all duration-200"
                >
