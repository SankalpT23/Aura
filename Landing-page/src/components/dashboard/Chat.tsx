          ...
          >
            <div className={`flex items-start gap-3 max-w-[80%] ${message.type === "user" ? "flex-row-reverse" : ""}`}>
              <Avatar className="w-8 h-8 shrink-0">
                <AvatarFallback className={message.type === "user" ? "bg-[var(--primary)] text-[var(--primary-foreground)]" : "bg-muted"}>
                  {message.type === "user" ? <User className="w-5 h-5" /> : <Bot className="w-5 h-5" />}
                </AvatarFallback>
              </Avatar>
              
              <div className="space-y-2">
                <Card className={`p-4 ${message.type === "user" ? "bg-[var(--primary)] text-[var(--primary-foreground)] ml-auto" : ""}`}>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {message.suggestions.map((suggestion, index) => (
                      <Button
                        ...
                        className="text-xs h-7 hover:bg-[var(--primary)]/10 hover:border-[var(--primary)]/50"
                      >
                        {suggestion}
                      </Button>
                    ))}
        ...
        <div className="flex items-end gap-3">
          <div className="flex-1">
            <Input
              ...
              className="min-h-[48px] bg-muted/50 border-border focus:border-[var(--primary)] resize-none"
              disabled={isTyping}
            />
          </div>
          <Button
            ...
            className="h-12 w-12 bg-[var(--primary)] text-[var(--primary-foreground)] hover:opacity-90 p-0"
          >
