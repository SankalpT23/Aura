      ...
      <Card className="p-4">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-12 bg-muted/50 border-border focus:border-[var(--primary)]"
          />
        </div>
      </Card>
              ...
              {categories.map((category) => (
                <Button
                  ...
                  className={`w-full justify-between h-10 ${
                    selectedCategory === category.id ? "bg-[var(--primary)] text-[var(--primary-foreground)]" : ""
                  }`}
        ...
        <div className="lg:col-span-3 space-y-4">
          {filteredNews.length === 0 ? (
            ...
            filteredNews.map((item) => (
              <Card key={item.id} className="p-6 hover:shadow-lg transition-all duration-200">
                <div className="space-y-4">
                  ...
                  {/* Content */}
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2 hover:text-[var(--primary)] cursor-pointer transition-colors">
                      {item.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-border">
                    ...
                    <Button variant="ghost" size="sm">
                      <Bookmark className={`w-4 h-4 ${item.isBookmarked ? "fill-[var(--primary)] text-[var(--primary)]" : ""}`} />
                    </Button>
                  </div>
                </div>
              </Card>
